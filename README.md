...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/redis-semaphore-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10930&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/redis-semaphore-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `redis-semaphore` can be installed with:

```
conda install redis-semaphore
```

It is possible to list all of the versions of `redis-semaphore` available on your platform with:
